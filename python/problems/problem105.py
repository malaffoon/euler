...
seven to twelve elements (the two examples given above are the first two sets in the file), identify all
the special sum sets, A1, A2, ..., Ak, and find the value of S(A1) + S(A2) + ... + S(Ak).
...
if __name__ == '__main__':
    print("The answer is", Problem105.solve())
